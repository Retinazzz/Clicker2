...
public class deaglebullet : MonoBehaviour
{
    ...
    private void Start()
    {
        PlayerPrefs.GetInt("deaglebullet", Explosionvalue);
        PlayerPrefs.GetInt("deaglebulletcost", cost);
    }
    ...
    public void AddValue(int value)
    {
        ...
        PlayerPrefs.SetInt("deaglebullet", Explosionvalue);
        PlayerPrefs.SetInt("deaglebulletcost", cost);
    }
}
